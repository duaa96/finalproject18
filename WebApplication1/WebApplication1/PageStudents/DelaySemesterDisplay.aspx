<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/PageStudents/student.Master"  CodeBehind="DelaySemesterDisplay.aspx.cs" Inherits="WebApplication1.PageStudents.DelaySemesterDisplay" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    margin: 0 auto; margin-right:7%; margin-left:3%; ">
            <h2 style="float: none;
    margin: 0 auto; font-family:'Amiri'">  تأجيل فصل دراسي </h2><br />
    ...
    <asp:GridView ID="gvDelaySemester"    style="width:1100px; margin-top:20px;" runat="server"   OnRowDeleting="gvDelaySemester_RowDeleting" AutoGenerateColumns="False" DataKeyNames="ID" OnRowDataBound="gvDelaySemester_Data" CellPadding="3" OnRowCommand="gvDelaySemester_RowCommand" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
