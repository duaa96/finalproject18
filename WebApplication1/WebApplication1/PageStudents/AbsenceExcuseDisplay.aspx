...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="gvAbsenseExam"    style="width:1100px; margin-top:10px;" runat="server"   OnRowDeleting="gvAbsenseExam_RowDeleting" AutoGenerateColumns="False" DataKeyNames="ID" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowCommand="gvAbsenseExam_RowCommand">
