<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/PageStudents/student.Master" CodeBehind="AltiSubjectAll.aspx.cs" Inherits="WebApplication1.PageStudents.AltiSubjectAll" %>
  ...
  <div class=" w3-white w3-center navbar navbar-expand-lg  " style=" float: none; direction:rtl; 
    ...
    margin: 0 auto; margin-right:7%; margin-left:3%; ">
      ...
      <div class=" w3-row form-group float-right " style="direction:rtl; margin-right:0.5%; margin-left:3%; width:950px;" >
          ...
          <asp:RadioButtonList ID="rbtRegAccept" style="float:right;  font-family:'Amiri'; font-size:x-large;" RepeatLayout="Table" CssClass="RBL"  runat="server" RepeatDirection="Horizontal" Enabled="false" >
               <asp:ListItem Text="موافق" Value="1" />
               <asp:ListItem Text="غير موافق" Value="2" />
          </asp:RadioButtonList>
      </div>
