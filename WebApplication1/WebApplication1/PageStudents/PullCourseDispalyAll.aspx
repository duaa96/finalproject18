 ...
 <table class=" w3-responsive float-right w3-table w3-striped w3-border" style="direction:rtl;float:right;   font-family:'Amiri';">
  ...
  ForeColor="Red"></asp:RequiredFieldValidator>1- </td>
      <td><span>
          ...
          <asp:DropDownList ID="ddlNameCourse1" runat="server" OnSelectedIndexChanged="ddlNameCourse1_SelectedIndexChanged" CssClass="form-control w3-margin-right w3-margin-left bg-white" width="200px" AutoPostBack="true" Enabled="False">
          </asp:DropDownList>
          </span></td>
      <td>
          <asp:TextBox ID="txtNumCourse1" runat="server" CssClass="form-control  w3-margin-right bg-white " width="200px"  OnTextChanged="txtNumCourse1_TextChanged" AutoPostBack="true" Enabled="False"></asp:TextBox>
    ...
    <tr  style="font-size:large;">
      <td>2-</td>
      <td>
          <asp:DropDownList ID="ddlNameCourse2" runat="server" CssClass="form-control w3-margin-right bg-white" width="200px" OnSelectedIndexChanged="ddlNameCourse2_SelectedIndexChanged" AutoPostBack="true" Enabled="False">
          </asp:DropDownList>
          </td>

          <td> 
              <asp:TextBox ID="txtNumCourse2" runat="server" CssClass="form-control w3-margin-right bg-white " Rows="2" width="200px" OnTextChanged="txtNumCourse2_TextChanged" AutoPostBack="true" Enabled="False"></asp:TextBox>
</td>
    ...
    <tr  style="font-size:large;">
      ...
      <td>
          ...
          <asp:DropDownList ID="ddlNameCourse3" runat="server" CssClass="form-control w3-margin-right bg-white" width="200px" OnSelectedIndexChanged="ddlNameCourse3_SelectedIndexChanged" AutoPostBack="true" Enabled="False">
          </asp:DropDownList>
        </td>
      <td>  
          
          <asp:TextBox ID="txtNumCourse3" runat="server" CssClass="form-control w3-margin-right bg-white " Rows="2" width="200px" OnTextChanged="txtNumCourse3_TextChanged" AutoPostBack="true" Enabled="False"></asp:TextBox>
</td>
