...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    margin: 0 auto; margin-right:7%; margin-left:3%; ">
            <h2 style="float: none;
    margin: 0 auto; font-family:'Amiri'">  سحب مساق </h2><br />
    ...
    <asp:GridView ID="gvPullCourse"    style="width:1100px; margin-top:20px" runat="server"   OnRowDeleting="gvPullCoursedelete_RowDeleting" OnRowDataBound="gvPullCourse_Data" AutoGenerateColumns="False" DataKeyNames="ID" CellPadding="3" OnRowCommand="gvPullCourseView_RowCommand" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
