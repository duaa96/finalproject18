<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/PageStudents/student.Master" CodeBehind="AltiSubjectDisplay.aspx.cs" Inherits="WebApplication1.PageStudents.AltiSubjectDisplay" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    margin: 0 auto; margin-right:7%; margin-left:3%; ">
            <h2 style="float: none;
    margin: 0 auto; font-family:'Amiri'">  مساق بديل للتخرج </h2><br />
    ...
    <asp:GridView ID="gvAltiSubject"    style="width:1100px; margin-top:10px;" runat="server"   OnRowDeleting="gvAltiSubject_RowDeleting" AutoGenerateColumns="False" DataKeyNames="ID" OnRowDataBound="gvAltiSubject_Data" CellPadding="3" OnRowCommand="gvAltiSubject_RowCommand" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
        ...
        <Columns >
            ...
            <asp:BoundField DataField="RegestrationAccept" HeaderText="قرار دائرة القبول و التسجيل" SortExpression="RegestrationAccept" />
                                        

             <asp:TemplateField ShowHeader="False">
                   <ItemTemplate>
                       <asp:Button ID="btnedit" runat="server"  CssClass="btn btn-lg w3-blue" Text="عرض" CommandName="dispaly1" CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>'/>
                   </ItemTemplate>          
             </asp:TemplateField> 
             <asp:TemplateField ShowHeader="False">
                   <ItemTemplate>
