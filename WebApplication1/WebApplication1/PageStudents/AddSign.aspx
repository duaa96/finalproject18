...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <div class=" w3-white w3-center navbar navbar-expand-lg  w3-margin-top  w3-padding-64 " style=" float: none;
    ...
    margin: 0 auto; " >
             <asp:Button ID="Button2" runat="server" OnClick="btnSave_Click" Text="انشاء توقيع " class="btn btn-danger btn-lg w3-margin-top" align="center" style="float: none; margin: 0 auto;" />
