<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="Acadimic.Master" CodeBehind="processAltiSubAcadimic.aspx.cs" Inherits="WebApplication1.PageEmployee.processAltiSubAcadimic" %>
 ...
 <table class=" w3-responsive float-right w3-table w3-striped w3-border" style="direction:rtl;float:right;   font-family:'Amiri';">
  ...
  <div class=" w3-white w3-center navbar navbar-expand-lg  " style=" float: none; direction:rtl; 
   ...
   <div class="form-group float-right col-5" style="direction:rtl; margin-right:0.4%; " >
    ...
    margin: 0 auto; " >
          <asp:Button ID="btnSaveAcadimic" runat="server" Text="حفظ" class="btn btn-lg btn-danger" align="center" OnClick="btnSaveAcadimic_Click"  />
