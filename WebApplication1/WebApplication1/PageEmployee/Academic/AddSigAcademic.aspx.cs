...
{
    public partial class AddSigAcademic : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('لديك توقيع سابق اذااردت تغيره انتقل الى تجديد التوقيع');window.location ='HomeAcademic.aspx';", true);
                }
            }
        }
