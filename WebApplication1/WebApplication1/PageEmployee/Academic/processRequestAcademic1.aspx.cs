...
{
    public partial class processRequestAcademic1 : System.Web.UI.Page
    {
        ...
        protected void gvRequest_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "process")
            {
                ...
                if (ddlRequest.SelectedValue.ToString() == "4")
                {
                    ...
                    Response.Redirect("processAltiSubAcadimic.aspx?id=" + val);
                ...
                else if (ddlRequest.SelectedValue.ToString() == "5")
                {
                    ...
                    Response.Redirect("processDropAcadimic.aspx?id=" + val);
