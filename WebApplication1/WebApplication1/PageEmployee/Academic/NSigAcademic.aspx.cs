...
{
    public partial class NSigAcademic : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('ليس لديك توقيع سابق انتقل لصفحة انشاء التوقيع ');window.location ='HomeAcademic.aspx';", true);
            }
        }
        ...
        protected void btnResetPass_Click(object sender, EventArgs e)
        {
            ...
            S.sendemailNewSignatureEmpAcad(email, ID);
