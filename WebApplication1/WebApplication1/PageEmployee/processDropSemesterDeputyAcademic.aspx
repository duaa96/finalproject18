<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/PageEmployee/employee.Master" CodeBehind="processDropSemesterDeputyAcademic.aspx.cs" Inherits="WebApplication1.PageEmployee.processDropSemesterDeputyAcademic" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <div class=" w3-white w3-center navbar navbar-expand-lg  " style=" float: none; direction:rtl; 
    ...
    margin: 0 auto; margin-right:7%; margin-left:3%; ">
      ...
      <label for="exampleInpuStudentsNum"  style="float:right;  font-family:'Amiri'; font-size:x-large;"> ملاحظات النائب الأكاديمي:
         <asp:RequiredFieldValidator runat="server" ForeColor="Red" ID="RequiredFieldValidator8" ControlToValidate="txtDescriptinDep" ErrorMessage="*"></asp:RequiredFieldValidator>
 ...
 <div class=" w3-white w3-center navbar navbar-expand-lg  " style=" float: none; direction:rtl; 
    margin: 0 auto; margin-right:7%; margin-left:3%; ">
      ...
      <div class=" w3-row form-group float-right " style="direction:rtl; margin-right:0.5%; margin-left:3%; width:950px;" >
      <asp:TextBox ID="txtDescriptinDep" runat="server"   CssClass="form-control w3-margin-right col-12  bg-white " Height="100px"   align="right" style="right: 0px"></asp:TextBox>
    ...
    <div class=" w3-white w3-center navbar navbar-expand-lg  " style=" float: none; direction:rtl; 
    margin: 0 auto; margin-right:7%; margin-left:3%; ">
         <asp:RequiredFieldValidator runat="server" ForeColor="Red" ID="RequiredFieldValidator3" ControlToValidate="rbtDepAcept" ErrorMessage="*"></asp:RequiredFieldValidator>

      <div class=" w3-row form-group float-right " style="direction:rtl; margin-right:0.5%; margin-left:3%; width:950px;" >
     
          <asp:RadioButtonList ID="rbtDepAcept" style="float:right;  font-family:'Amiri'; font-size:x-large;" RepeatLayout="Table" CssClass="RBL"  runat="server" RepeatDirection="Horizontal" Enabled="true" >
               <asp:ListItem Text="موافق" Value="1" />
               <asp:ListItem Text="غير موافق" Value="2" />
          </asp:RadioButtonList>
      </div>
 ...
 <div class=" w3-white w3-center navbar navbar-expand-lg  " style=" float: none; direction:rtl; 
    margin: 0 auto; margin-right:7%; margin-left:3%; ">
      ...
      <asp:Label ID="dfDateDep"  style="float:right;  font-family:'Amiri'; font-size:large;" runat="server" Text="Label">التاريخ:</asp:Label>
    
      <asp:Label ID="labDateDep"  style="float:right;  font-family:'Amiri'; font-size:x-large;" runat="server" Text="Label"></asp:Label>
     </div>  
          <div class="col-1">

          </div>
           <div class="form-group float-right col-5" style="direction:rtl; "  >
       <asp:Label ID="dfinfoDep" runat="server"  style="float:right;  font-family:'Amiri'; font-size:large;" >التوقيع:</asp:Label>

         <asp:RequiredFieldValidator runat="server" ForeColor="Red" ID="RequiredFieldValidator7" ControlToValidate="fuSignatureDep" ErrorMessage="*"></asp:RequiredFieldValidator>

      <asp:FileUpload ID="fuSignatureDep" runat="server" />
       <asp:Label ID="errorDep" runat="server" style="float:right;  font-family:'Amiri'; font-size:large;" Visible="False" ForeColor="#FF3300"></asp:Label>
     </div>  
           <div class="col-1">
   ...
   <div class="form-group float-right col-5" style="direction:rtl; margin-right:0.4%; " >
    ...
    margin: 0 auto; " >
          <asp:Button ID="btnSaveDep" runat="server" Text="حفظ" class="btn btn-lg w3-green " align="center" Width="100"  OnClick="btnSaveDep_Click"  />
