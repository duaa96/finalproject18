<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/PageEmployee/Reg.Master"  CodeBehind="NSigReg.aspx.cs" Inherits="WebApplication1.PageEmployee.NSigReg" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    margin: 0 auto; " >
          <asp:Button ID="btnResetPass" runat="server" Text="تجديد التوقيع" class="btn btn-lg w3-green " align="center" Width="100"  OnClick="btnResetPass_Click"   />
