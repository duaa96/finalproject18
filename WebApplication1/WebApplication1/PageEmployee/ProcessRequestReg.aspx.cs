...
{
    public partial class ProcessRequestReg : System.Web.UI.Page
    {
        ...
        protected void gvRequest_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "process")
            {
                ...
                {
                    if (position == 3)
                        Response.Redirect("processShowStatusHead.aspx?id=" + val);

                    else if (position == 2)
                        Response.Redirect("processShowStatusDean.aspx?id=" + val);

                }
                else if (ddlRequest.SelectedValue.ToString() == "2")
                {
                    if (position == 3)
                        Response.Redirect("processPullCourseHead.aspx?id=" + val);
                    else if (position == 2)
                        Response.Redirect("processPullCourseDean.aspx?id=" + val);
                    ...
                    Response.Redirect("processAbsenceExam.aspx?id=" + val);
                else if (ddlRequest.SelectedValue.ToString() == "4")
                {

                    if (position == 3)
                        Response.Redirect("processAltSubjectHead.aspx?id=" + val);

                    else if (position == 2)
                        Response.Redirect("processAltSubjectDean.aspx?id=" + val);
                ...
                {
                    if (position == 3)
                        Response.Redirect("processDropSemesterHead.aspx?id=" + val);

                    else if (position == 2)
                        Response.Redirect("processDropSemesterDean.aspx?id=" + val);
                ...
                {
                    if (position == 2)
                        Response.Redirect("processDelaySemesterDean.aspx?id=" + val);
