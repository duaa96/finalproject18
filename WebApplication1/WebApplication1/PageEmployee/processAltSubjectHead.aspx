<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/PageEmployee/employee.Master" CodeBehind="processAltSubjectHead.aspx.cs" Inherits="WebApplication1.PageEmployee.processAltSubjectHead" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> 
 ...
 <div class=" w3-white w3-center navbar navbar-expand-lg  " style=" float: none; direction:rtl; 
   ...
   <div class="form-group float-right col-5" style="direction:rtl; margin-right:0.4%; " >
    ...
    margin: 0 auto; " >
          <asp:Button ID="btnSaveHead" runat="server" Text="حفظ" class="btn btn-lg btn-primary" align="center" OnClick="btnSaveHead_Click"  />
