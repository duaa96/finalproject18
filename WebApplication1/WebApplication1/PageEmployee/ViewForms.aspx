<%@ Page Language="C#" AutoEventWireup="true"   MasterPageFile="~/PageEmployee/Reg.Master" CodeBehind="ViewForms.aspx.cs" Inherits="WebApplication1.PageEmployee.ViewForms" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    margin: 0 auto; margin-right:7%; margin-left:3%; ">
            <h2 style="float: none;
    margin: 0 auto; font-family:'Amiri'">الطلبات التي  تقدم بها الطلاب   </h2><br />
        ...
        <Columns >
            ...
            <asp:BoundField DataField="UniversityID" HeaderText="رقم الطالب " SortExpression="UniversityID" />
             ...
             <asp:TemplateField ShowHeader="False">
                   <ItemTemplate>
                       <asp:Button ID="btnedit" runat="server" Text="معاينة" class="btn btn-danger" CommandName="process" CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>'/>
                   </ItemTemplate>          
            </asp:TemplateField>
